...
class Request implements BraspaglibRequestInterface, RequestInterface
{
    ...
    {
        $address = $this->getBillingAddressAttribute($this->getConfig()->getCustomerStreetAttribute());
        $address = $this->helperData->removeSpecialCharacters($address);
        return mb_substr($address, 0, 54);
    }
    ...
    {
        $complement = $this->getBillingAddressAttribute($this->getConfig()->getCustomerComplementAttribute());
        $complement = $this->helperData->removeSpecialCharacters($complement);
        return mb_substr($complement, 0, 14);
    }
    ...
    {
        $address = $this->getShippingAddressAttribute($this->getConfig()->getCustomerStreetAttribute());
        $address = $this->helperData->removeSpecialCharacters($address);
        return mb_substr($address, 0, 54);
    }
    ...
    {
        $number = $this->getShippingAddressAttribute($this->getConfig()->getCustomerNumberAttribute());
        $number = $this->helperData->removeSpecialCharacters($number);
        return mb_substr($number, 0, 5);
    }
    ...
    {
        $complement = $this->getShippingAddressAttribute($this->getConfig()->getCustomerComplementAttribute());
        $complement = $this->helperData->removeSpecialCharacters($complement);
        return mb_substr($complement, 0, 14);
    }
    ...
    public function getPaymentProvider()
    {
        ...
        return ($provider) ? $provider : 'Cielo30';
    }
    ...
    {
        return str_replace([' ','.'], '', $this->getPaymentData()->getCcNumber());
    }
